...
public class NameApp {
    public static void main(String[] args) {
        ...
        String[] names = new String[1000000000]; // 비어있는 배열 선언
        int index = 0; // 입력된 이름 데이터 순서
        ...
        while (true) {
            ...
            if (str1.equals("help")) { // str1이 "help"와 같은 경우
                ...
                System.out.println("exit : 종료"); // > 를 출력함.
                ...
                for (int i = 0; i < index; i++){ //i 는 배열순서 배열의 방을 가르킴 0부터 시작하고 1씩 증가한다.
                    System.out.println((i+1) + ". " + names[i]); //(i+1)은 배열이 0부터 시작하기 때문이다. "1."를 만들기 위함
                }
