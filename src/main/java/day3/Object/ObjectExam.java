package day3.Object;
// '설계도이름(class명)' '생성하고싶은 객체이름' = new '설계도이름(class)'();
public class ObjectExam {
    public static void main(String[] args) {
        ...
        Cat cat1 = new Cat(); // Cat이라는 설계도를 보고 cat1이라는 이름으로 인스턴스 생성해줘
        cat1.name = "아리";
        cat1.age = 4;
        cat1.kind = "러시안블루";
        ...
        Warrior w1 = new Warrior(); // Warrior 설계도보고 w1 이라는 객체 만들어줘.
        w1.name = "이순신"; // 그 객체에 데이터 넣어줘
        w1.attack = 20;
        w1.defense = 10;
